...
### 3.2 Inspection Service Management

#### 3.2.1 Manage Assets and Periodic Inspection Scheduling
...
#### 3.2.2 Review Request and Assign Inspector
...
#### 3.2.3 Execute Inspection and Verify Findings
...
- Eligible images may be submitted to YOLO. Each candidate records model version, label, confidence, and bounding box.
- The Inspector reviews every candidate and chooses Confirm, Modify, or Reject. The Inspector may also add a missed finding manually.
- Only confirmed, modified, or manually added findings enter official statistics and report content.

**Validation and exception requirements:** Unsupported or corrupted files are rejected. Interrupted uploads retry without duplicate evidence records. AI failure does not discard evidence or prevent manual findings. An Inspector cannot update another Inspector's assignment without a separate authorized role and scope.

**Result:** The inspection has completed checklist responses, traceable evidence, and Inspector-verified findings.

#### 3.2.4 Review and Release Inspection Report
...
#### 3.3.1 Create and Assess Maintenance Ticket
...
#### 3.3.2 Prepare and Approve Maintenance Work
...
#### 3.3.3 Execute Work and Manage Change
...
#### 3.3.4 Release and Resolve Maintenance Result
