---
title: "System Specification (FA26SE112)"
weight: 5
---

# SmartDroneInspection ΓÇö System Specification

> AI-powered Infrastructure Inspection Management Platform
> FA26SE112 ┬╖ Capstone Project ┬╖ Duration: 09/2026 ΓÇô 03/2027
> Supervisors: Phß║ím Minh Tr├¡ (tripm14@fpt.edu.vn), ─Éß║╖ng Ngß╗ìc Minh ─Éß╗⌐c (ducdnm2@fpt.edu.vn)

---

## 1. Overview

SmartDroneInspection manages the complete infrastructure inspection lifecycle ΓÇö assets, inspection planning, requests, drone missions, reports, defects, and maintenance tickets ΓÇö while consuming drone operation services from **SmartDroneHub** via standardized REST APIs.
...
### MF2 ΓÇö Inspection Planning & Request Management
...
### MF3 ΓÇö Drone Mission Execution (Integration)
...
### MF4 ΓÇö Inspection Report & Defect Management
...
### MF5 ΓÇö Maintenance Ticket Lifecycle
...
### MF6 ΓÇö Authentication & Access Control (cross-cutting)
1. User authenticates ΓåÆ JWT issued.
2. All endpoints enforce RBAC per the role table above.
3. All sensitive actions write audit logs.

### AI Services (cross-cutting)
- **DroneVisionAI** ΓÇö Inspection image analysis (defect detection). Used in MF4.
- **Report Summarization** ΓÇö LLM-based concise report summaries. Used in MF4.
- **DroneKnowledgeAI** ΓÇö Historical case recommendation (similar past cases + guidelines). Supports MF4/MF5.
...
|--------|--------------|-------|
| Trß║ºn Ho├áng Trung Hiß║┐u (Leader, SE184212) | WP1 | Requirement analysis, architecture, DB design, API spec, UI/UX; project foundation (auth, RBAC, audit log); Dashboard & Analytics; coordination & code review |
| Ph├╣ng Trung Quß╗æc (SE170027) | WP2 | Asset Management module; Inspection Planning & Request Management; scheduling + notification services |
| Tr╞░╞íng Th├íi Nh╞░ (SE180082) | WP3 | SmartDroneHub integration (Mission API, telemetry, SignalR); Inspection Report, Defect, Maintenance Ticket modules |
| Trß║ºn T├╣ng B├ích (SE180220) | WP4 | Flutter mobile app (Inspector + Maintenance Engineer flows); Evidence management (MinIO); AI services (DroneVisionAI, Report Summarization, DroneKnowledgeAI) |
...
| Weeks | Milestone |
|-------|-----------|
| 1ΓÇô3 | WP1 complete: requirements frozen, DB schema, API spec, UI mockups |
| 4ΓÇô12 | WP2ΓÇôWP4 in parallel (backend modules, frontend portal, mobile app, AI services) |
| 8 | Mid-term demo: core flows MF1, MF2 end-to-end |
| 12 | Feature freeze: all main flows demoable |
| 12ΓÇô15 | WP5: testing, Docker deployment, documentation, final defense |
