...
| 2026-09-24 | 0.9 | Shared API response contract | M | Recorded backend and first-party client tests for the successful JSON envelope while preserving existing error and bodyless-response contracts. | Backend `ApiResponseTest`; frontend/mobile envelope tests; Report 3 sections 4.1 and 5.2 |
